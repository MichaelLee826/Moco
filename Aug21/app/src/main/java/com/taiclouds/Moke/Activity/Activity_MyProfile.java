...
public class Activity_MyProfile extends Activity {
    ...
    private ImageButton myAccountImageButton;
    ...
    public void init(){
        //友盟推送的统计
        PushAgent.getInstance(Activity_MyProfile.this).onAppStart();
        ...
        myAccountImageButton = (ImageButton)findViewById(R.id.MyProfileMyAccountImageButton);
    ...
    public void setListeners(){
        ...
        //我的账户
        myAccountImageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Activity_MyProfile.this, Activity_MyProfile_MyAccount.class);
                startActivity(intent);
            }
        });
