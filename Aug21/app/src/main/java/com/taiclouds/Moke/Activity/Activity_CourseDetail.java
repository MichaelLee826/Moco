...
import com.taiclouds.Moke.Adapter.Adapter_Category;
import com.taiclouds.Moke.Adapter.Adapter_CourseIntro_ViewPager;
...
public class Activity_CourseDetail extends Activity {
    private IWXAPI api;
    private PopupWindow shareBoardPopupWindow;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                ...
                case SET_PICTURE:
                    ...
                    Glide.with(Activity_CourseDetail.this).load(bytes).crossFade().into(pictureImageView);
                    break;
            }
        }
    };
    ...
    public void init(){
        // 微信注册初始化
        api = WXAPIFactory.createWXAPI(this, "wx2036c148b5eb11c3", true);
        api.registerApp("wx2036c148b5eb11c3");

        //开源项目ScrollableLayout的控件
    ...
    public void shareContent(){
        View view = LayoutInflater.from(getApplicationContext()).inflate(R.layout.popup_window_shareboard, null);
        ImageView WeChatSceneSession = (ImageView)view.findViewById(R.id.shareBoard_WeChat_SceneSession_ImageView);
        ImageView WeChatSceneTimeline = (ImageView)view.findViewById(R.id.shareBoard_WeChat_SceneTimeline_ImageView);


        shareBoardPopupWindow = new PopupWindow(findViewById(R.id.Activity_Course_Layout));
        shareBoardPopupWindow.setContentView(view);
        shareBoardPopupWindow.setFocusable(true);

        shareBoardPopupWindow.setWidth(WindowManager.LayoutParams.MATCH_PARENT);
        shareBoardPopupWindow.setHeight(WindowManager.LayoutParams.WRAP_CONTENT);

        //不设置背景的话下面的代码不管用
        shareBoardPopupWindow.setBackgroundDrawable(this.getResources().getDrawable(R.drawable.slide_dot_white));
        shareBoardPopupWindow.setOutsideTouchable(true);
        shareBoardPopupWindow.showAtLocation(Activity_CourseDetail.this.findViewById(R.id.coursedetail_enrollButton), Gravity.BOTTOM|Gravity.CENTER_HORIZONTAL, 0, 0);

        WeChatSceneSession.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //发送给好友
                share2WeChat(0);
                shareBoardPopupWindow.dismiss();
                shareBoardPopupWindow = null;
            }
        });

        WeChatSceneTimeline.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //发送到朋友圈
                share2WeChat(1);
    ...
    private void share2WeChat(int flag) {
        if (!api.isWXAppInstalled()) {
            Toast.makeText(Activity_CourseDetail.this, "您还未安装微信客户端",
        ...
        switch (flag){
            case 0:
                ...
                //友盟社交分享统计
                UMPlatformData platform0 = new UMPlatformData(UMPlatformData.UMedia.WEIXIN_FRIENDS, userName);
                MobclickAgent.onSocialEvent(this, platform0);
            ...
            case 1:
                ...
                //友盟社交分享统计
                UMPlatformData platform1 = new UMPlatformData(UMPlatformData.UMedia.WEIXIN_CIRCLE, userName);
                MobclickAgent.onSocialEvent(this, platform1);
