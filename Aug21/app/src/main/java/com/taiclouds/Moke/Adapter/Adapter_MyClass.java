...
public class Adapter_MyClass extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String address = "地点：" + cityNameStrings[position] + districtNameStrings[position] + addressStrings[position];
        ...
        if (viewHolder == null){
            ...
            viewHolder.pictureImageView = (ImageView)convertView.findViewById(R.id.MyClassItemImageView);
        ...
        Glide.with(context).load(R.mipmap.class1).crossFade().into(viewHolder.pictureImageView);
