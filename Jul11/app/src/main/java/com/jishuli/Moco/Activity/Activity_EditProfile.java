...
public class Activity_EditProfile extends Activity {
    ...
    public class nameListener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            //在对话框里添加一个EditText
            LayoutInflater layoutInflater = LayoutInflater.from(Activity_EditProfile.this);
            final View usernameView = layoutInflater.inflate(R.layout.dialog_name, null);

            //找到EditText控件
            final EditText nameEditText = (EditText)usernameView.findViewById(R.id.Dialog_Name_EditText);
    ...
    public class cityListener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            //在对话框里添加两个Spinner
            LayoutInflater layoutInflater = LayoutInflater.from(Activity_EditProfile.this);
            final View view = layoutInflater.inflate(R.layout.dialog_city, null);
