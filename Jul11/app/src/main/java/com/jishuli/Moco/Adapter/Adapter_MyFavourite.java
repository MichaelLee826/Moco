...
/**
 * Created by MichaelLee826 on 2016-06-27-0027.
 */
public class Adapter_MyFavourite extends BaseAdapter{
    ...
    public Adapter_MyFavourite(Context context, String[] statusStrings, String[] courseIDStrings,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (viewHolder == null){
            convertView = LayoutInflater.from(context).inflate(R.layout.myfavourite_item, null);

            viewHolder = new ViewHolder();
            viewHolder.courseNameTextView = (TextView)convertView.findViewById(R.id.MyFavouriteItemClassNameTextView);
            //viewHolder.firstTextView = (TextView)convertView.findViewById(R.id.MyFavouriteItemFirstTextView);
            //viewHolder.secondTextView = (TextView)convertView.findViewById(R.id.MyFavouriteItemSecondTextView);
            viewHolder.dateTextView = (TextView)convertView.findViewById(R.id.MyFavouriteItemDateTextView);
            viewHolder.courseTime1TextView = (TextView)convertView.findViewById(R.id.MyFavouriteItemTimeTextView);
            viewHolder.addressTextView = (TextView)convertView.findViewById(R.id.MyFavouriteItemAddressTextView);
        ...
        viewHolder.dateTextView.setText(beginTimeStrings[position]);
        viewHolder.courseTime1TextView.setText(courseTime1);
        viewHolder.addressTextView.setText(cityNameStrings[position]);
