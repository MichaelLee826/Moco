...
import com.jishuli.Moco.Adapter.Adapter_MyFavourite;
...
public class Activity_MyProfile_MyFavourite extends Activity {
    private static final String PATH = "http://120.25.166.18/followedCourse";
    ...
    //1.初始化
    public void init(){
        backButton = (ImageButton)findViewById(R.id.MyFavouriteBackgroundLayoutBackButton);
        listView = (ListView)findViewById(R.id.MyFavouriteListView);
    }
    ...
    public void setListeners(){
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Activity_MyProfile_MyFavourite.this.finish();
            }
        });
    }
    ...
    public void setListView(){
        listAdapter = new Adapter_MyFavourite(this, statusStrings, courseIDStrings, courseNameStrings,
