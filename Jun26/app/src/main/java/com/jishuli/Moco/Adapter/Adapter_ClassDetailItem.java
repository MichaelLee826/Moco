...
public class Adapter_ClassDetailItem extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (viewHolder == null){
            convertView = LayoutInflater.from(context).inflate(R.layout.classdetail_item, null);
        ...
        if (classDetailItem.status.equals("即将开课")){
            viewHolder.statusTextView.setText("即将开课");
        }
        else if (classDetailItem.status.equals("已结束")){
